...
const DEFAULT_FOOTER = {
  logoText: 'TechFlow',
  companyDescription:
    'Revolutionizing business automation with cutting-edge AI technology. Join thousands of startups and enterprises who trust our platform to scale their operations.',
  contactEmail: 'hello@techflow.ai',
  ...
  newsletterDisclaimer: 'Get exclusive insights and product updates. No spam, unsubscribe anytime.',
  ...
  // Product Links
  linkFeatures: 'AI Automation',
  linkFeaturesHref: '#features',
  linkPricing: 'Pricing',
  linkPricingHref: '#pricing',
  linkTemplates: 'Workflows',
  linkTemplatesHref: '/workflows',
  ...
  linkWebinars: 'Live Demos',
  linkWebinarsHref: '/demos',
